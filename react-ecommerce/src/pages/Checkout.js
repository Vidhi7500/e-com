...
function Checkout() {
  ...
  return (
    <>
      ...
      <div className="mx-auto  max-w-7xl px-15 pb-10 pt-6 sm:px-6 lg:px-8 ">
        <div className="grid grid-cols-1 px-10 gap-x-8 gap-y-10 lg:grid-cols-5">
                        ...
                        <div className="ml-4 flex flex-1 flex-col">
                          <div>
                            <div className="flex justify-between text-base font-medium text-gray-900">
                              <h3>
                                <a href={item.product}>{item.product.title}</a>
                              </h3>
                              <p className="ml-4">
